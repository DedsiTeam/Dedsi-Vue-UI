<template>
  <div class="dedsi-table-demo">
    ...
    <p class="page-desc">基于 Vue3 的表格组件，支持分页功能</p>
        ...
        >
          ...
          <template #action="{ row }">
            <DedsiSpace size="small">
              ...
              <DedsiButton size="small" type="danger" @click="handleDelete(row)">删除</DedsiButton>
            </DedsiSpace>
          </template>
        </DedsiTable>
      </DedsiCard>
...
const columns: Column[] = [
  ...
  { key: 'name', title: '姓名', width: '120px', align: 'center' },
